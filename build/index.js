  ...
  window.tinymce.PluginManager.add("szeducate_table", function (editor) {
      ...
      runEdit(() => {
        ...
        if (rowspan > 1) {
          ...
          for (let i = 1; i < rowspan; i++) {
            ...
            if (before) curRow.insertBefore(newCell, before);else curRow.appendChild(newCell);
          }
    ...
    editor.addButton("szeducate_table_edit", {
      ...
      menu: [{
        ...
        text: "Sor másolása",
        onclick: withCell(duplicateRow)
      }, {
        text: "Sor törlése",
        onclick: withCell(deleteRow)
      }, {
        text: "Sor magassága...",
        onclick: withCell(rowHeightDialog)
      }, {
        text: "-"
      }, {
        ...
        onclick: withCell(duplicateColumn)
      }, {
        text: "Oszlop törlése",
        onclick: withCell(deleteColumn)
      }, {
        text: "Oszlop szélessége...",
        onclick: withCell(columnWidthDialog)
      }, {
        text: "-"
      }, {
        ...
        text: "Cella felosztása",
        onclick: withCell(splitCell)
      }, {
        text: "-"
      }, {
    ...
    if (window.wp && window.wp.editor) {
      ...
      window.wp.editor.initialize(editorId, {
        tinymce: {
          ...
          toolbar1: "formatselect,bold,italic,underline,bullist,numlist,link,unlink,forecolor,backcolor,szeducate_table_insert,szeducate_table_edit",
          // A húzással kijelölt táblázat-cellák vizuális kiemelése (lásd a
          // szeducate_table plugin egér-figyelését).
          content_style: ".szeducate-cell-selected{background-color:rgba(34,113,177,0.25) !important;outline:1px solid #2271b1;}",
...
const SZEducateEditor = () => {
  ...
  const [versionsSource, setVersionsSource] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)("hub");
  ...
  const [lockInfo, setLockInfo] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useState)({
    locked: false,
    lockedByClient: "",
    lockedByUser: ""
  });
  ...
  const changedFieldKeys = Array.from(new Set(allSchemaFields.filter(f => isFieldChangedSinceSave(f.key)).map(f => f.key)));
  const changedSinceSave = [...(title !== savedSnapshot.current.title ? ["Cím"] : []), ...changedFieldKeys.map(key => fieldLabelByKey[key] || key)];
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, "Figyelem:"), " Nincs jogosults\xE1god a k\xE9pz\xE9s adatainak m\xF3dos\xEDt\xE1s\xE1ra. Az \u0171rlap csak olvashat\xF3 m\xF3dban ny\xEDlt meg."), !globalReadonly && isLockedByOther && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Notice, {
    status: "warning",
    isDismissible: false,
    style: {
      marginBottom: "20px"
    }
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, "Figyelem:"), " Ezt a K\xE9pz\xE9st jelenleg", " ", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, lockInfo.lockedByUser), " szerkeszti a(z)", " ", (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", null, lockInfo.lockedByClient), " oldalon. Am\xEDg ott nyitva van a szerkeszt\u0151, itt csak megtekintheted az adatokat - \xEDgy elker\xFClhet\u0151, hogy k\xE9t hely egym\xE1s ment\xE9s\xE9t \xEDrja fel\xFCl."), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      display: "flex",
      gap: "20px",
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", null, "K\xE9pz\xE9s R\xE9szletei ", effectiveReadonly ? "(Csak Megtekintés)" : ""), !effectiveReadonly && overallRequired.length > 0 && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("span", {
    style: {
      fontSize: "12px",
      fontWeight: 500,
  ...
  }), !effectiveReadonly && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
    isPrimary: true,
    isLarge: true,
    style: {
      width: "100%",
  ...
  }, globalReadonly ? "Nincs jogosultságod módosítani ezt a képzést." : isLockedByOther ? "Amíg más szerkeszti máshol, itt nem menthetsz." : "A csillaggal (*) jelölt mezők kitöltése kötelező."))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    style: {
      background: "#fff",
      border: "1px solid #c3c4c7",
      borderRadius: "6px",
  ...
  }, "Friss\xEDt\xE9s") : null), postId && !isLoadingVersions && versionsSource === "local" && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    style: {
      fontSize: "11px",
      color: "#996800",
      background: "#fff8e5",
  ...
  }, "A Hub jelenleg nem \xE9rhet\u0151 el - csak az ezen a kliensen ismert (nem felt\xE9tlen\xFCl teljes) el\u0151zm\xE9ny l\xE1tszik."), !postId ? (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", {
    style: {
      fontSize: "12px",
      color: "#8c8f94",
      margin: 0
    ...
    }, "+", labels.length - 6, " tov\xE1bbi")), !isCurrent && !effectiveReadonly && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.Button, {
      isSecondary: true,
      isSmall: true,
      style: {
        marginTop: "10px"
